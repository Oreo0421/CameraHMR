...
echo "    下载: https://cocodataset.org/#download → 2017 Train images"
echo "    解压到: data/training-images/COCO/images/"
echo "    即: data/training-images/COCO/images/train2017/*.jpg"
echo ""
